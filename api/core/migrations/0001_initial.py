# Generated by Django 2.2.2 on 2019-06-05 13:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('ADMIN', 'Admin'), ('DOCTOR', 'Doctor')], max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital_visited', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='hospitals', to='core.Hospital')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_diagnosis', models.CharField(choices=[('DME', 'Diabetic macular edema'), ('AMD', 'Age-related macular degeneration'), ('NORMAL', 'Normal')], max_length=7)),
