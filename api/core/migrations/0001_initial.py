# Generated by Django 2.2.2 on 2019-06-08 12:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital_visited', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='hospital_visited', to='core.Hospital')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='diagnosis', to='core.Patient')),
            ],
        ),
        migrations.CreateModel(
            name='HospitalDoctor',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('doctor', models.ForeignKey(limit_choices_to={'title': 'DOCTOR'}, on_delete=django.db.models.deletion.PROTECT, related_name='practitioners', to=settings.AUTH_USER_MODEL)),
                ('hospital', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='doctors', to='core.Hospital')),
            ],
        ),
    ]
