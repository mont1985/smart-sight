# Generated by Django 2.2.2 on 2019-06-12 12:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrator', models.ForeignKey(limit_choices_to={'title': 'ADMIN'}, on_delete=django.db.models.deletion.CASCADE, related_name='administrator', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(null=True, upload_to='eye_photos/')),
                ...
                ('doctor', models.ForeignKey(limit_choices_to={'title': 'DOCTOR'}, on_delete=django.db.models.deletion.CASCADE, related_name='physician', to=settings.AUTH_USER_MODEL)),
                ('hospital_visited', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hospital_visited', to='core.Hospital')),
                ('patient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='diagnosis', to='core.Patient')),
            ],
        ),
        migrations.CreateModel(
            name='HospitalDoctor',
            fields=[
                ...
                ('doctor', models.ForeignKey(limit_choices_to={'title': 'DOCTOR'}, on_delete=django.db.models.deletion.CASCADE, related_name='practitioners', to=settings.AUTH_USER_MODEL)),
